...
export const MODULES = [
  { href: "/", tKey: "dailyBrief", icon: icon(
    "M3 3h7v7H3z", "M14 3h7v7h-7z", "M3 14h7v7H3z", "M14 14h7v7h-7z",
  ) },
  { href: "/assistant", tKey: "aiAssistant", icon: icon(
