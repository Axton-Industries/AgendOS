      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <section className="card">
          ...
          <ul className="divide-y divide-zinc-800 text-sm">
            ...
            {visible.length === 0 && <li className="py-2 text-zinc-500">No reminders.</li>}
          </ul>
        </section>
      </div>

      <p className="text-xs text-zinc-600">
        In-app reminders and calendar notifications for now — external email integration (IMAP/Gmail) can be added to this module later.
      </p>
    </div>
  );
}
